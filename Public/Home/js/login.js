$(function () {
    $.fn.bannerShow = function (g) {
        g = jQuery.extend({wraper: "fshow", autotime: 6000, isAuto: true, ind: 0, changeColor: null}, g || {});
    ...
    if (!!document.createElement("canvas").getContext) {
        $.getScript("http://www.kingzhuyun.com/js/cpgwjs/cav.js", function () {
            var t = {width: 1.5, height: 1.5, depth: 10, segments: 15, slices: 8, xRange: 0.8, yRange: 0.1, zRange: 1, ambient: "#3f7bed", diffuse: "#FFFFFF", speed: 0.0003};
            var G = {
                count: 2,
                xyScalar: 1,
                zOffset: 100,
            ...
            C();
            $("#fshow").bannerShow({changeColor: J})
        })
    } else {
        $("#fshow").bannerShow()
    }
